...
import 'package:kalbemd/blesscom/pages/input_promo/input_promo_detail.dart';
...
class InputPromo extends StatefulWidget {
  ...
  @override
  _InputPromoState createState() => _InputPromoState();
}
...
class _InputPromoState extends State<InputPromo> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputPromoDetail(
              infoLog: widget.infoLog,
              master: data,
              queryPromo: widget.infoLog["infoLog"]["query_nama_promo"],
              queryYTMekanisme: widget.infoLog["infoLog"]["query_ytmekanisme"],
            ),
          ),
        )
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Input Keterjadian Promo"),
            ),
            content: Column(
                    ...
                    .push(
                      MaterialPageRoute(
                        builder: (context) => InputPromoDetail(
                          ...
                          queryPromo: widget.infoLog["infoLog"]
                              ["query_nama_promo"],
                          queryYTMekanisme: widget.infoLog["infoLog"]
                              ["query_ytmekanisme"],
                        ),
                      ),
                    )
