...
import 'package:kalbemd/blesscom/pages/foto_smd/foto_smd_detail.dart';
...
class FotoSMD extends StatefulWidget {
  ...
  @override
  _FotoSMDState createState() => _FotoSMDState();
}

class _FotoSMDState extends State<FotoSMD> {
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Foto Activity"),
            ),
            content: Column(
