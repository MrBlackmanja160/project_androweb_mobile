...
class PengembalianProduk extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const PengembalianProduk({
  ...
  @override
  _PengembalianProdukState createState() => _PengembalianProdukState();
}

class _PengembalianProdukState extends State<PengembalianProduk> {
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Pengembalian?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "pengembalian";
      request.files.add(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: SizedBox(
          height: Helper.getScreenHeight(context) - kToolbarHeight - 20,
          child: Column(
            children: [
              Padding(
