...
import 'package:kalbemd/blesscom/pages/penjualan/penjualan_produk_add.dart';
...
class PenjualanProduk extends StatefulWidget {
  ...
  @override
  _PenjualanProdukState createState() => _PenjualanProdukState();
}

class _PenjualanProdukState extends State<PenjualanProduk> {
  ...
  void _addItem() {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => PenjualanProdukAdd(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Penjualan?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "penjualan";
      request.files.add(
