...
class PenjualanProdukAdd extends StatefulWidget {
  final dynamic master;
  final String queryAddPenjualanProduk;

  const PenjualanProdukAdd({
  ...
  @override
  _PenjualanProdukAddState createState() => _PenjualanProdukAddState();
}

class _PenjualanProdukAddState extends State<PenjualanProdukAdd> {
