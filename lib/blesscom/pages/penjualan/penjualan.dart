...
import 'package:kalbemd/blesscom/pages/penjualan/penjualan_produk.dart';
...
class _PenjualanState extends State<Penjualan> {
  ...
  Future<Iterable<Map<String, dynamic>>> _generateData() async {
    ...
    if (response.success) {
      ...
      for (var element in data) {
        ...
        bool ytSdhsetor = element["ytsdhsetor"] == "O";
        ...
        element["ytsdhsetor"] = Container(
          decoration: BoxDecoration(
            color: ytSdhsetor ? Colors.red : Colors.green,
            borderRadius: BorderRadius.circular(8),
          ),
          child: Text(
            ytSdhsetor ? "BLM" : "SDH",
            textAlign: _headers
                .firstWhere((element) => element.value == "ytsdhsetor")
                .textAlign,
          ),
        );
      }
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => PenjualanProduk(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Penjualan"),
            ),
            content: Column(
