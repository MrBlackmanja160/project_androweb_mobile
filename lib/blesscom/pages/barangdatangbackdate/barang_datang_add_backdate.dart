...
class BarangDatangAddBackdate extends StatefulWidget {
  ...
  @override
  _BarangDatangAddBackdateState createState() =>
      _BarangDatangAddBackdateState();
}

class _BarangDatangAddBackdateState extends State<BarangDatangAddBackdate> {
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlBarangDatangAddBackdate,
                onSubmit: _onSubmit,
              ),
            ),
    );
