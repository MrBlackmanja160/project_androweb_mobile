...
class BarangDatangEditDetailBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const BarangDatangEditDetailBackdate({
  ...
  @override
  _BarangDatangEditDetailBackdateState createState() =>
      _BarangDatangEditDetailBackdateState();
}

class _BarangDatangEditDetailBackdateState
    extends State<BarangDatangEditDetailBackdate> {
