...
class BarangDatangAddDetailBackdate extends StatefulWidget {
  final dynamic master;
  final String queryAddBarangDatang;

  const BarangDatangAddDetailBackdate({
    required this.master,
    required this.queryAddBarangDatang,
    Key? key,
  }) : super(key: key);

  @override
  _BarangDatangAddDetailBackdateState createState() =>
      _BarangDatangAddDetailBackdateState();
}

class _BarangDatangAddDetailBackdateState
    extends State<BarangDatangAddDetailBackdate> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddBarangDatang,
      },
      {
        "nm": "qty",
        "jns": "number",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlBarangDatangDetailAddBackdate,
                onSubmit: _onSubmit,
              ),
            ),
    );
