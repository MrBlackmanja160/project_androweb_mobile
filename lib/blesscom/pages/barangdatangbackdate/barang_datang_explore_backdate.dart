...
import 'package:kalbemd/blesscom/pages/barangdatang/barang_datang_editdetail.dart';
import 'package:kalbemd/blesscom/pages/barangdatangbackdate/barang_datang_editdetail_backdate.dart';
...
class BarangDatangExploreBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const BarangDatangExploreBackdate({
  ...
  @override
  _BarangDatangExploreBackdateState createState() =>
      _BarangDatangExploreBackdateState();
}

class _BarangDatangExploreBackdateState
    extends State<BarangDatangExploreBackdate> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => BarangDatangEditDetailBackdate(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Barang Datang?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "Barangdatang";
      request.files.add(
