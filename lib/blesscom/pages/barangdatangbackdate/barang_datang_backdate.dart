...
import 'package:kalbemd/blesscom/pages/barangdatangbackdate/barang_datang_add_backdate.dart';
import 'package:intl/intl.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';

import 'barang_datang_explore_backdate.dart';

class BarangDatangBackdate extends StatefulWidget {
  final dynamic infoLog;
  const BarangDatangBackdate({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _BarangDatangBackdateState createState() => _BarangDatangBackdateState();
}

class _BarangDatangBackdateState extends State<BarangDatangBackdate> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => BarangDatangExploreBackdate(
  ...
  void _addItem() async {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => BarangDatangAddBackdate(
              infoLog: widget.infoLog,
