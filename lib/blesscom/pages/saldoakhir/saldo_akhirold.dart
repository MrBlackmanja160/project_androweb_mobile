...
class SaldoAkhirOld extends StatefulWidget {
  final dynamic infoLog;

  const SaldoAkhirOld({required this.infoLog, Key? key}) : super(key: key);

  @override
  _SaldoAkhirOldState createState() => _SaldoAkhirOldState();
}

class _SaldoAkhirOldState extends State<SaldoAkhirOld> {
