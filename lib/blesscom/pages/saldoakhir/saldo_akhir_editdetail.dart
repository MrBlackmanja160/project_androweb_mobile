...
class SaldoAkhirEditDetail extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const SaldoAkhirEditDetail({
  ...
  @override
  _SaldoAkhirEditDetailState createState() => _SaldoAkhirEditDetailState();
}

class _SaldoAkhirEditDetailState extends State<SaldoAkhirEditDetail> {
