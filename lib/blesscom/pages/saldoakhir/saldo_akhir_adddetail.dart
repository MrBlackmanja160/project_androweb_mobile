...
class SaldoAkhirAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddSaldoAkhir;

  const SaldoAkhirAddDetail({
  ...
  @override
  _SaldoAkhirAddDetailState createState() => _SaldoAkhirAddDetailState();
}

class _SaldoAkhirAddDetailState extends State<SaldoAkhirAddDetail> {
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlSaldoAkhirDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
