...
class SaldoAkhirExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const SaldoAkhirExplore({
  ...
  @override
  _SaldoAkhirExploreState createState() => _SaldoAkhirExploreState();
}

class _SaldoAkhirExploreState extends State<SaldoAkhirExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => SaldoAkhirEditDetail(
