// ignore_for_file: unused_element, unnecessary_nullable_for_final_variable_declarations, unused_field, library_private_types_in_public_api, duplicate_ignore, sort_child_properties_last
...
import 'saldo_akhir_explore.dart';

class SaldoAkhir extends StatefulWidget {
  ...
  @override
  _SaldoAkhirState createState() => _SaldoAkhirState();
}

class _SaldoAkhirState extends State<SaldoAkhir> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => SaldoAkhirExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti SaldoAkhir"),
            ),
            content: Column(
