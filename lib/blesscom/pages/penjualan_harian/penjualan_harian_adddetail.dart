...
class PenjualanHarianAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddStokAwal;

  const PenjualanHarianAddDetail({
  ...
  @override
  _PenjualanHarianAddDetailState createState() =>
      _PenjualanHarianAddDetailState();
}

class _PenjualanHarianAddDetailState extends State<PenjualanHarianAddDetail> {
