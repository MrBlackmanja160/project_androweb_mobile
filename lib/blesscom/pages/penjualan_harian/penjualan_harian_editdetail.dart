...
class PenjualanHarianEditDetail extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const PenjualanHarianEditDetail({
  ...
  @override
  _PenjualanHarianEditDetailState createState() =>
      _PenjualanHarianEditDetailState();
}

class _PenjualanHarianEditDetailState extends State<PenjualanHarianEditDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Penjualan Hari Ini"),
      ),
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlPenjualanHarianDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
