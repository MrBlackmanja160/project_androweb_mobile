...
import 'package:kalbemd/blesscom/pages/penjualan_harian/penjualan_harian_editdetail.dart';
...
class PenjualanHarianExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const PenjualanHarianExplore({
  ...
  @override
  _PenjualanHarianExploreState createState() => _PenjualanHarianExploreState();
}

class _PenjualanHarianExploreState extends State<PenjualanHarianExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => PenjualanHarianEditDetail(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Penjualan Hari Ini?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "Penjualanharian";
      request.files.add(
