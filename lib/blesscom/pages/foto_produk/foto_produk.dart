...
import 'package:kalbemd/blesscom/pages/foto_produk/foto_produk_detail.dart';
...
class FotoProduk extends StatefulWidget {
  ...
  @override
  _FotoProdukState createState() => _FotoProdukState();
}
...
class _FotoProdukState extends State<FotoProduk> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => FotoProdukDetail(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Foto Activity Motoris"),
            ),
            content: Column(
