...
class PembelianProdukAdd extends StatefulWidget {
  final dynamic master;
  final String queryAddPembelianProduk;

  const PembelianProdukAdd({
    required this.master,
    required this.queryAddPembelianProduk,
    Key? key,
  }) : super(key: key);

  @override
  _PembelianProdukAddState createState() => _PembelianProdukAddState();
}

class _PembelianProdukAddState extends State<PembelianProdukAdd> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddPembelianProduk,
      },
      {
        "nm": "qty",
        "jns": "number",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlPembelianDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
