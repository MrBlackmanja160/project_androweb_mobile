...
import 'package:kalbemd/blesscom/pages/pembelian/pembelian_produk_add.dart';
...
class _PembelianProdukState extends State<PembelianProduk> {
  ...
  void _addItem() {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => PembelianProdukAdd(
                master: widget.master,
                queryAddPembelianProduk: widget.infoLog["infoLog"]
                    ["query_add_pembelianproduk"]),
          ),
        )
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Pembelian?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "pembelian";
      request.files.add(
