...
class StokAwalExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const StokAwalExplore({
  ...
  @override
  _StokAwalExploreState createState() => _StokAwalExploreState();
}

class _StokAwalExploreState extends State<StokAwalExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => StokAwalEditDetail(
