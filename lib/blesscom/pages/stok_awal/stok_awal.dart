...
class StokAwal extends StatefulWidget {
  ...
  @override
  _StokAwalState createState() => _StokAwalState();
}

class _StokAwalState extends State<StokAwal> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => StokAwalExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti StokAwal"),
            ),
            content: Column(
