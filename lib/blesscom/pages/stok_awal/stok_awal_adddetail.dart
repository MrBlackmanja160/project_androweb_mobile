...
class StokAwalAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddStokAwal;

  const StokAwalAddDetail({
  ...
  @override
  _StokAwalAddDetailState createState() => _StokAwalAddDetailState();
}

class _StokAwalAddDetailState extends State<StokAwalAddDetail> {
