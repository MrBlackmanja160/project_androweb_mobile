...
import 'package:kalbemd/blesscom/pages/input_harga_kompetitor/input_harga_kompetitor_explore.dart';
...
class InputHargaKompetitor extends StatefulWidget {
  final dynamic infoLog;
  const InputHargaKompetitor({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _InputHargaKompetitorState createState() => _InputHargaKompetitorState();
}

class _InputHargaKompetitorState extends State<InputHargaKompetitor> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputHargaKompetitorExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Input Harga Kompetitor"),
            ),
            content: Column(
