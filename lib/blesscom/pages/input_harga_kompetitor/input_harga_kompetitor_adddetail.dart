...
class InputHargaKompetitorAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddProdukKompetitor;

  const InputHargaKompetitorAddDetail({
    required this.master,
    required this.queryAddProdukKompetitor,
    Key? key,
  }) : super(key: key);

  @override
  _InputHargaKompetitorAddDetailState createState() =>
      _InputHargaKompetitorAddDetailState();
}

class _InputHargaKompetitorAddDetailState
    extends State<InputHargaKompetitorAddDetail> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddProdukKompetitor,
      },
      {
        "nm": "harga",
        "jns": "number",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlInputHargaKompetitorDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
