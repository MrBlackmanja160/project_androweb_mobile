...
import 'package:kalbemd/blesscom/pages/returbarangbackdate/retur_barang_editdetail_backdate.dart';
...
class ReturBarangExploreBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const ReturBarangExploreBackdate({
  ...
  @override
  _ReturBarangExploreBackdateState createState() =>
      _ReturBarangExploreBackdateState();
}

class _ReturBarangExploreBackdateState
    extends State<ReturBarangExploreBackdate> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => ReturBarangEditDetailBackdate(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Retur Barang?"),
        actions: [
          ElevatedButton(
            onPressed: () {
