...
class ReturBarangEditDetailBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const ReturBarangEditDetailBackdate({
  ...
  @override
  _ReturBarangEditDetailBackdateState createState() =>
      _ReturBarangEditDetailBackdateState();
}

class _ReturBarangEditDetailBackdateState
    extends State<ReturBarangEditDetailBackdate> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      //   "nm": "temp_idcheckin",
      //   "jns": "hidden",
      //   "value": widget.data["temp_idcheckin"],
      // },
      {
        "nm": "action",
        "jns": "hidden",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlReturBarangDetailAddBackdate,
                onSubmit: _onSubmit,
              ),
            ),
    );
