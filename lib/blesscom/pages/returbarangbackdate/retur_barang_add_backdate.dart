...
import 'package:kalbemd/blesscom/pages/returbarangbackdate/retur_barang_explore_backdate.dart';
import 'package:kalbemd/blesscom/pages/saldoakhirbackdate/saldo_akhir_explore_backdate.dart';

class ReturBarangAddBackdate extends StatefulWidget {
  // final dynamic master;
  final dynamic infoLog;
  final String queryKunjunganLalu;

  const ReturBarangAddBackdate({
  ...
  @override
  _ReturBarangAddBackdateState createState() => _ReturBarangAddBackdateState();
}

class _ReturBarangAddBackdateState extends State<ReturBarangAddBackdate> {
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlReturBarangAddBackdate,
                onSubmit: _onSubmit,
              ),
            ),
    );
