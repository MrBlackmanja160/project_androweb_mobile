...
class SaldoAkhirAddDetailBackdate extends StatefulWidget {
  final dynamic master;
  final String queryAddSaldoAkhir;

  const SaldoAkhirAddDetailBackdate({
    required this.master,
    required this.queryAddSaldoAkhir,
    Key? key,
  }) : super(key: key);

  @override
  _SaldoAkhirAddDetailBackdateState createState() =>
      _SaldoAkhirAddDetailBackdateState();
}

class _SaldoAkhirAddDetailBackdateState
    extends State<SaldoAkhirAddDetailBackdate> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddSaldoAkhir,
      },
      {
        "nm": "qty",
        "jns": "number",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlSaldoAkhirBackdateDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
