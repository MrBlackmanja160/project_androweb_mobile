...
import 'package:kalbemd/blesscom/pages/input_pkm/input_pkm_editdetail.dart';
import 'package:kalbemd/blesscom/pages/returbarang/retur_barang_editdetail.dart';
import 'package:kalbemd/blesscom/pages/saldoakhir/saldo_akhir_editdetail.dart';
import 'package:kalbemd/blesscom/pages/saldoakhirbackdate/saldo_akhir_editdetail_backdate.dart';
import 'package:kalbemd/blesscom/pages/stok_awal/stok_awal_editdetail.dart';
...
class SaldoAkhirExploreBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const SaldoAkhirExploreBackdate({
  ...
  @override
  _SaldoAkhirExploreBackdateState createState() =>
      _SaldoAkhirExploreBackdateState();
}

class _SaldoAkhirExploreBackdateState extends State<SaldoAkhirExploreBackdate> {
  ...
  final List<int> _perPages = [4];
  int _total = 100;
  int _currentPerPage = 4;
  List<bool>? _expanded;
  String _searchKey = "produk";
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => SaldoAkhirEditDetailBackdate(
  ...
  void _postingConfirm() async {
    ...
    HttpPostResponse response = await Helper.sendHttpPost(
      ...
      postData: {
        ...
        "mode": "posting",
        "temp_id": widget.master["temp_id"].toString(),
        "temp_idcheckin": widget.master["temp_idcheckin"].toString(),
      },
    );
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Saldo Akhir?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "returbarang";
      request.files.add(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: _editable ? _deleteMaster : null,
            icon: const Icon(
      ...
      body: SingleChildScrollView(
        child: SizedBox(
          height: Helper.getScreenHeight(context) - kToolbarHeight - 100,
          child: Column(
            children: [
              Padding(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            //           height: 160,
                            //           initialValue: _initialPhoto,
                            //           onChange: _uploadPhoto,
                            //           enabled: _editable && !_loadingPosting,
                            //         ),
                            // ),
                          ],
                        ),
              ...
              //     onPressed: _editable ? _addItem : null,
              //     child: Row(
              //       mainAxisAlignment: MainAxisAlignment.center,
              //       children: const [
              //         Icon(
