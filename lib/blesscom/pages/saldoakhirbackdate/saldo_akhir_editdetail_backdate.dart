...
class SaldoAkhirEditDetailBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const SaldoAkhirEditDetailBackdate({
  ...
  @override
  _SaldoAkhirEditDetailBackdateState createState() =>
      _SaldoAkhirEditDetailBackdateState();
}

class _SaldoAkhirEditDetailBackdateState
    extends State<SaldoAkhirEditDetailBackdate> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Saldo Akhir Detail"),
      ),
      body: _loading
