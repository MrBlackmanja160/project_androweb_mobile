// ignore_for_file: unused_element, unnecessary_nullable_for_final_variable_declarations, unused_field, library_private_types_in_public_api, duplicate_ignore
...
import 'package:kalbemd/blesscom/pages/saldoakhirbackdate/saldo_akhir_add_backdate.dart';
import 'package:kalbemd/blesscom/pages/saldoakhirbackdate/saldo_akhir_explore_backdate.dart';
import 'package:intl/intl.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';

class SaldoAkhirBackdate extends StatefulWidget {
  final dynamic infoLog;
  const SaldoAkhirBackdate({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _SaldoAkhirBackdateState createState() => _SaldoAkhirBackdateState();
}

class _SaldoAkhirBackdateState extends State<SaldoAkhirBackdate> {
  ...
  void _addItem() async {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => SaldoAkhirAddBackdate(
              infoLog: widget.infoLog,
              queryKunjunganLalu: widget.infoLog["infoLog"]
                  ["query_kunjungan_lalu"],
            ),
          ),
        )
                      ...
                      MaterialPageRoute(
                        builder: (context) => SaldoAkhirExploreBackdate(
                          ...
                          master: {
                            ...
                            "temp_idcheckin": response.data["temp_idcheckin"],
