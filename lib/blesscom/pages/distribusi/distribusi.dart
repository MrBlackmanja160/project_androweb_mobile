...
import 'package:kalbemd/blesscom/pages/distribusi/distribusi_produk.dart';
...
class Distribusi extends StatefulWidget {
  ...
  @override
  _DistribusiState createState() => _DistribusiState();
}
...
class _DistribusiState extends State<Distribusi> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => DistribusiProduk(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Distribusi Produk"),
            ),
            content: Column(
