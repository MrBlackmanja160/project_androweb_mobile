...
class ReturBarangExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const ReturBarangExplore({
  ...
  @override
  _ReturBarangExploreState createState() => _ReturBarangExploreState();
}

class _ReturBarangExploreState extends State<ReturBarangExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => ReturBarangEditDetail(
