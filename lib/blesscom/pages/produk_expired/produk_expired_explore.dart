...
import 'package:kalbemd/blesscom/pages/produk_expired/produk_expired_editdetail.dart';
...
class ProdukExpiredExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const ProdukExpiredExplore({
  ...
  @override
  _ProdukExpiredExploreState createState() => _ProdukExpiredExploreState();
}

class _ProdukExpiredExploreState extends State<ProdukExpiredExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => ProdukExpiredEditDetail(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Produk Expired ?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "Produkexpired";
      request.files.add(
