...
class ProdukExpiredEditDetail extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const ProdukExpiredEditDetail({
  ...
  @override
  _ProdukExpiredEditDetailState createState() =>
      _ProdukExpiredEditDetailState();
}

class _ProdukExpiredEditDetailState extends State<ProdukExpiredEditDetail> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      },
      {
        ...
        "label": "Tgl Exp",
        "required": "Y",
        "value": widget.data["tglexpired"].toString(),
      },
    ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Produk Expired"),
      ),
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlProdukExpiredDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
