...
import 'package:kalbemd/blesscom/pages/produk_expired/produk_expired_explore.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';

// import 'stok_awal_explore.dart';

class ProdukExpired extends StatefulWidget {
  ...
  @override
  _ProdukExpiredState createState() => _ProdukExpiredState();
}

class _ProdukExpiredState extends State<ProdukExpired> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => ProdukExpiredExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Produk Expired"),
            ),
            content: Column(
