...
class ProdukExpiredAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddStokAwal;

  const ProdukExpiredAddDetail({
  ...
  @override
  _ProdukExpiredAddDetailState createState() => _ProdukExpiredAddDetailState();
}

class _ProdukExpiredAddDetailState extends State<ProdukExpiredAddDetail> {
