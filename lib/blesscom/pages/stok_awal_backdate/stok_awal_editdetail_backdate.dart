...
class StokAwalEditDetailBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic data;

  const StokAwalEditDetailBackdate({
  ...
  @override
  _StokAwalEditDetailBackdateState createState() =>
      _StokAwalEditDetailBackdateState();
}

class _StokAwalEditDetailBackdateState
    extends State<StokAwalEditDetailBackdate> {
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlStokAwalBackdateDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
