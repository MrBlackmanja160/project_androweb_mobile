...
import 'package:kalbemd/blesscom/pages/stok_awal_backdate/stok_awal_editdetail_backdate.dart';
...
class StokAwalExploreBackdate extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const StokAwalExploreBackdate({
  ...
  @override
  _StokAwalExploreBackdateState createState() =>
      _StokAwalExploreBackdateState();
}

class _StokAwalExploreBackdateState extends State<StokAwalExploreBackdate> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => StokAwalEditDetailBackdate(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Stok Awal?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "Stokawal";
      request.files.add(
