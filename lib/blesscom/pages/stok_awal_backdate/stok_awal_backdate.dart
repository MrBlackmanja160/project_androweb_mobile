...
import 'package:kalbemd/blesscom/pages/stok_awal_backdate/stok_awal_add_backdate.dart';
import 'package:intl/intl.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';

import 'stok_awal_explore_backdate.dart';

class StokAwalBackdate extends StatefulWidget {
  final dynamic infoLog;
  const StokAwalBackdate({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _StokAwalBackdateState createState() => _StokAwalBackdateState();
}

class _StokAwalBackdateState extends State<StokAwalBackdate> {
  bool _editable = false;
  // List<Map<String, String>> _ieKunjungan = [];
  ...
  void _onTabRow(dynamic data) {
    ...
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => StokAwalExploreBackdate(
  ...
  void _addItemConfirm(String pelanggan) async {
    if (mounted) {
      setState(() {
        _loadingAdd = true;
      });
