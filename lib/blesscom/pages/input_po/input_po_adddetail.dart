...
class InputPOAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddPenjualanProduk;

  const InputPOAddDetail({
  ...
  @override
  _InputPOAddDetailState createState() => _InputPOAddDetailState();
}

class _InputPOAddDetailState extends State<InputPOAddDetail> {
