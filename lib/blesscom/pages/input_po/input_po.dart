...
class InputPO extends StatefulWidget {
  ...
  @override
  _InputPOState createState() => _InputPOState();
}

class _InputPOState extends State<InputPO> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputPOExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti InputPO"),
            ),
            content: Column(
