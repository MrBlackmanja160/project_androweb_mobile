...
class InputPOExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const InputPOExplore({
  ...
  @override
  _InputPOExploreState createState() => _InputPOExploreState();
}

class _InputPOExploreState extends State<InputPOExplore> {
  ...
  void _addItem() {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputPOAddDetail(
