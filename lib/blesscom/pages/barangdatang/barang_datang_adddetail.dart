...
class BarangDatangAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddBarangDatang;

  const BarangDatangAddDetail({
  ...
  @override
  _BarangDatangAddDetailState createState() => _BarangDatangAddDetailState();
}

class _BarangDatangAddDetailState extends State<BarangDatangAddDetail> {
