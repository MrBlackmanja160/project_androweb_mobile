...
import 'barang_datang_explore.dart';

class BarangDatang extends StatefulWidget {
  ...
  @override
  _BarangDatangState createState() => _BarangDatangState();
}

class _BarangDatangState extends State<BarangDatang> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => BarangDatangExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti BarangDatang"),
            ),
            content: Column(
