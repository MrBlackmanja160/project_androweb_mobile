...
class BarangDatangExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const BarangDatangExplore({
  ...
  @override
  _BarangDatangExploreState createState() => _BarangDatangExploreState();
}

class _BarangDatangExploreState extends State<BarangDatangExplore> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => BarangDatangEditDetail(
