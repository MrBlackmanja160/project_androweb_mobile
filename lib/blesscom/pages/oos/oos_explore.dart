...
import 'package:kalbemd/blesscom/pages/oos/oos_editdetail.dart';
...
class OosExplore extends StatefulWidget {
  ...
  @override
  _OosExploreState createState() => _OosExploreState();
}

class _OosExploreState extends State<OosExplore> {
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti OOS ?"),
        actions: [
          ElevatedButton(
            onPressed: () {
