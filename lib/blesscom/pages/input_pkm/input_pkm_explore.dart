...
class InputPkmExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const InputPkmExplore({
  ...
  @override
  _InputPkmExploreState createState() => _InputPkmExploreState();
}

class _InputPkmExploreState extends State<InputPkmExplore> {
  ...
  //       .push(
  //         MaterialPageRoute(
  //           builder: (context) => InputPkmAddDetail(
  //             master: widget.master,
  //             queryAddInputPkm: widget.infoLog["infoLog"]
  //                 ["query_add_InputPkm"],
  //           ),
  //         ),
  //       )
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputPkmEditDetail(
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "InputPkm";
      request.files.add(
