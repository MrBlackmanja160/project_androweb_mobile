...
import 'package:kalbemd/blesscom/pages/input_harga_kalbe/input_harga_kalbe_adddetail.dart';
...
class InputHargaKalbeExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const InputHargaKalbeExplore({
  ...
  @override
  _InputHargaKalbeExploreState createState() => _InputHargaKalbeExploreState();
}

class _InputHargaKalbeExploreState extends State<InputHargaKalbeExplore> {
  ...
  void _addItem() {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputHargaKalbeAddDetail(
              master: widget.master,
              queryProdukKalbe: widget.infoLog["infoLog"]
                  ["query_add_produkkalbe"],
            ),
          ),
        )
  ...
  void _deleteItemConfirm(dynamic data) async {
    HttpPostResponse response = await Helper.sendHttpPost(
      urlInputHargaKalbeDetailDelete,
      postData: {
        "iduser": await Helper.getPrefs("iduser"),
        "token": await Helper.getPrefs("token"),
        "temp_id": widget.master["temp_id"].toString(),
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Input Harga Toko?"),
        actions: [
          ElevatedButton(
            onPressed: () {
