...
import 'package:kalbemd/blesscom/pages/input_harga_kalbe/input_harga_kalbe_explore.dart';
...
class InputHargaKalbe extends StatefulWidget {
  final dynamic infoLog;
  const InputHargaKalbe({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _InputHargaKalbeState createState() => _InputHargaKalbeState();
}

class _InputHargaKalbeState extends State<InputHargaKalbe> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputHargaKalbeExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Input Harga Kalbe"),
            ),
            content: Column(
