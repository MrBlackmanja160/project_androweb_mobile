...
import 'update_harga_explore.dart';

class UpdateHarga extends StatefulWidget {
  ...
  @override
  _UpdateHargaState createState() => _UpdateHargaState();
}

class _UpdateHargaState extends State<UpdateHarga> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => UpdateHargaExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti UpdateHarga"),
            ),
            content: Column(
