...
class UpdateHargaAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddUpdateHarga;

  const UpdateHargaAddDetail({
    required this.master,
    required this.queryAddUpdateHarga,
    Key? key,
  }) : super(key: key);

  @override
  _UpdateHargaAddDetailState createState() => _UpdateHargaAddDetailState();
}

class _UpdateHargaAddDetailState extends State<UpdateHargaAddDetail> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddUpdateHarga,
      },
      {
        "nm": "qty",
        "jns": "number",
