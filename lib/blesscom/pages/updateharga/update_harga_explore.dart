...
import 'package:kalbemd/blesscom/pages/updateharga/update_harga_editdetail.dart';
...
class UpdateHargaExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const UpdateHargaExplore({
  ...
  @override
  _UpdateHargaExploreState createState() => _UpdateHargaExploreState();
}

class _UpdateHargaExploreState extends State<UpdateHargaExplore> {
  ...
  //       .push(
  //         MaterialPageRoute(
  //           builder: (context) => UpdateHargaAddDetail(
  //             master: widget.master,
  //             queryAddUpdateHarga: widget.infoLog["infoLog"]
  //                 ["query_add_UpdateHarga"],
  //           ),
  //         ),
  //       )
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => UpdateHargaEditDetail(
  ...
  //   HttpPostResponse response = await Helper.sendHttpPost(
  //     urlUpdateHargaDetailDelete,
  //     postData: {
  //       "iduser": await Helper.getPrefs("iduser"),
  //       "token": await Helper.getPrefs("token"),
  //       "temp_id": widget.master["temp_id"],
  //       "id": data["id"],
  //     },
  //   );
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Input PO?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "UpdateHarga";
      request.files.add(
