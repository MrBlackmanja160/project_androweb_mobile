...
class InputPenjualanSales extends StatefulWidget {
  final dynamic infoLog;
  const InputPenjualanSales({
    required this.infoLog,
    Key? key,
  }) : super(key: key);

  @override
  _InputPenjualanSalesState createState() => _InputPenjualanSalesState();
}

class _InputPenjualanSalesState extends State<InputPenjualanSales> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputPenjualanSalesExplore(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti InputPenjualanSales"),
            ),
            content: Column(
