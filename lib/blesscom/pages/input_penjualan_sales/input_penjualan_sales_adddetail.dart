...
class InputPenjualanSalesAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddPenjualanProduk;

  const InputPenjualanSalesAddDetail({
    required this.master,
    required this.queryAddPenjualanProduk,
    Key? key,
  }) : super(key: key);

  @override
  _InputPenjualanSalesAddDetailState createState() =>
      _InputPenjualanSalesAddDetailState();
}

class _InputPenjualanSalesAddDetailState
    extends State<InputPenjualanSalesAddDetail> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddPenjualanProduk,
      },
      {
        "nm": "qty",
        "jns": "number",
      ...
      body: _loading
          ...
          : Padding(
              ...
              child: InputBuilder(
                ieMaster: _ieMaster,
                submitLabel: "Simpan",
                actionUrl: urlInputPenjualanSalesDetailAdd,
                onSubmit: _onSubmit,
              ),
            ),
    );
