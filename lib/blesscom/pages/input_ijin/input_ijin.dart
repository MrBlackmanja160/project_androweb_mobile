...
import 'package:kalbemd/blesscom/pages/input_ijin/explore_ijin.dart';
import 'package:kalbemd/blesscom/pages/input_ijin/input_ijin_explore.dart';
import 'package:kalbemd/blesscom/pages/input_penjualan_sales/input_penjualan_sales_explore.dart';
import 'package:kalbemd/blesscom/pages/input_po/input_po_explore.dart';
...
class InputIjin extends StatefulWidget {
  ...
  @override
  _InputIjinState createState() => _InputIjinState();
}

class _InputIjinState extends State<InputIjin> {
  ...
  Future<Iterable<Map<String, dynamic>>> _generateData() async {
    ...
    if (response.success) {
      ...
      setState(() {
        jmlsakit = response.data["jmlsakit"];
        jmlcuti = response.data["jmlcuti"];
        jmlijin = response.data["jmlijin"];
        jmloff = response.data["jmloff"];
      });
      ...
      if (sukses) {
        setState(() => _loadingGenerate = false);
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti InputIjin"),
            ),
            content: Column(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ExploreIjin(
                          ...
                          master: {
                            ...
                            "tglinvoice": response.data["tglinvoice"],
