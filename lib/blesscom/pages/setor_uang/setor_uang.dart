...
import 'package:kalbemd/blesscom/pages/setor_uang/setor_uang_detail.dart';
...
class SetorUang extends StatefulWidget {
  ...
  @override
  _SetorUangState createState() => _SetorUangState();
}

class _SetorUangState extends State<SetorUang> {
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => SetorUangDetail(
        ...
        builder: (context) {
          return AlertDialog(
            title: const Padding(
              ...
              child: Text("Tambah Bukti Setor Uang"),
            ),
            content: Column(
