...
import 'package:kalbemd/blesscom/pages/input_stok/input_stok_editdetail.dart';
...
class InputStokExplore extends StatefulWidget {
  final dynamic infoLog;
  final dynamic master;

  const InputStokExplore({
  ...
  @override
  _InputStokExploreState createState() => _InputStokExploreState();
}

class _InputStokExploreState extends State<InputStokExplore> {
  ...
  //       .push(
  //         MaterialPageRoute(
  //           builder: (context) => InputStokAddDetail(
  //             master: widget.master,
  //             queryAddInputStok: widget.infoLog["infoLog"]
  //                 ["query_add_inputstok"],
  //           ),
  //         ),
  //       )
  ...
  void _onTabRow(dynamic data) {
    Navigator.of(context)
        .push(
          MaterialPageRoute(
            builder: (context) => InputStokEditDetail(
  ...
  void _deleteMaster() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Yakin Hapus Bukti Input Stok?"),
        actions: [
          ElevatedButton(
            onPressed: () {
  ...
  void _uploadPhoto(String value) async {
    ...
    try {
      ...
      request.fields["transaksi"] = "InputStok";
      request.files.add(
