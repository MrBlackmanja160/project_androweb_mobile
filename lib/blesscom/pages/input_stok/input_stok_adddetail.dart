...
class InputStokAddDetail extends StatefulWidget {
  final dynamic master;
  final String queryAddInputStok;

  const InputStokAddDetail({
    required this.master,
    required this.queryAddInputStok,
    Key? key,
  }) : super(key: key);

  @override
  _InputStokAddDetailState createState() => _InputStokAddDetailState();
}

class _InputStokAddDetailState extends State<InputStokAddDetail> {
  ...
  void _initForm() async {
    ...
    _ieMaster = [
      ...
      // },
      {
        ...
        "required": "Y",
        "customquery": widget.queryAddInputStok,
      },
      {
        "nm": "qty",
        "jns": "number",
